...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex flex-wrap mx-auto justify-content-center addWindow p-5 glass-object">
        ...
        <asp:CheckBox CssClass="my-2 me-2 fs-5 " ID="InPromo" runat="server" Text="In saldo" />
        </div>
        <div class="addForm">
        ...
        <asp:Button CssClass="my-2 btn btn-primary btn-lg align-self-end" ID="Add" runat="server" Text="Aggiungi" OnClick="Aggiungi_Click" />
        </div>
    </div>
